...
<!-- Changes under tis section is customized for RERA Bihar -->
	<div class="row">
		<div class="col-md-3 col-sm-6 col-xs-6"><p class="text-right">Type of Occupancy <span class="space_LR">:</span></p></div>
		<div class="col-md-3 col-sm-6 col-xs-6" ><p>${preobj.typeOfLand} </p></div>
		<div class="col-md-3 col-sm-6 col-xs-6"><p class="text-right">If Orhers, Remarks<span class="space_LR">:</span></p></div>
		<div class="col-md-3 col-sm-6 col-xs-6" ><p>${preobj.othersOccupancy}  </p></div>
	</div>
	<div class="row">
		<div class="col-md-3 col-sm-6 col-xs-6"><p class="text-right">Is there any Cases Pending <span class="space_LR">:</span></p></div>
		<div class="col-md-3 col-sm-6 col-xs-6" ><p>${preobj.isCasesPending} </p></div>
		<div class="col-md-3 col-sm-6 col-xs-6"><p class="text-right">Reason of Pending<span class="space_LR">:</span></p></div>
		<div class="col-md-3 col-sm-6 col-xs-6" ><p>${preobj.caseDetails}  </p></div>
	</div>	
	<div class="row">
		<div class="col-md-3 col-sm-6 col-xs-6"><p class="text-right">Previous given date of completion <span class="space_LR">:</span></p></div>
		<div class="col-md-3 col-sm-6 col-xs-6" ><p>${preobj.prevCompletionDate} </p></div>
		<div class="col-md-3 col-sm-6 col-xs-6"><p class="text-right">Reason for delay in completion of project<span class="space_LR">:</span></p></div>
		<div class="col-md-3 col-sm-6 col-xs-6" ><p>${preobj.prjDelayReason}  </p></div>
	</div>
<!--  -->	
	<div class="row">
		<div class="col-md-3 col-sm-6 col-xs-6"><p class="text-right">Address<span class="space_LR">:</span></p></div>
