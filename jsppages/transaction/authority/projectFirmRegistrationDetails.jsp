...
<!-- Adding the Previous Details values -->	
   ...
   <div class="row">
	...
	<div class="row">
		...
		<div class="col-md-3 col-sm-6 col-xs-6" ><p>${project.projectDetailsModel.areaOfGarageForSale}  </p></div>
																																														...
																																														<div class="row">
		<div class="col-md-3 col-sm-6 col-xs-6"><p class="text-right">No of Parking for Sale (Sq Mtr)<span class="space_LR">:</span></p></div>
...
<form name="trxForm" action="revokeProjectRegistration" method="post">
...
<div class="button-wrapper">
   ...
   <input name="btn1" class="btn-style" value="Enquiry" type="button"  />
     ...
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <a target="_blank" href="<%= request.getContextPath()%>/projectCert?PID=${project.projectRegId}">  <input name="btn1" class="btn-style" value="View Certificate" type="button"  /> </a></div>
