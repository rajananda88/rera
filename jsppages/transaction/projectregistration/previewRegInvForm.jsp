...
<form:form class="form-horizontal" action="#" modelAttribute="projectRegistrationModel" method="post" id="previewtrxForm" >
			...
			<div class="inner_wrapper">
				...
				<div class="border">
					...
					<tr class="form-group">
						...
						<td class="col-sm-3 control-label">Name<sup>*</sup></td>
						<td >
						...
						<td for="inputEmail3" class="col-sm-2 control-label">Father's
							Name<sup>*</sup></td>
							
						<td >
								
							 <form:input size="50" path="promoterDetailsModel.promoterIndividualFatherName" disabled="true" id="promoterIndividualFatherName" cssClass="form-control"/>	
						</td>
</tr>
					...
					<tr class="form-group">
					<td  for="inputEmail3" class="col-sm-3 control-label">PAN
							Number<sup>*</sup></td>
						<td class="col-sm-3">
								 <form:input path="promoterDetailsModel.panNo" disabled="true" id="panNo" cssClass="form-control input-sm"/>	
					
						</td>
						<td  for="inputEmail3" class="col-sm-2 control-label">Aadhaar 
							Number<sup>*</sup></td>
						<td class="col-sm-2">
					...
					<td >
						...
						<label for="inputEmail3" class="col-sm-3 control-label">
							E-mail<sup>*</sup></label></td>
						<td class="col-sm-3" width="150%">
...
<td>
					...
					<tr class="form-group">
					<td >
						<label for="inputEmail3" class="col-sm-3 control-label">Pin Code<sup>*</sup></label></td>
						<td class="col-sm-3">
					 ...
					 <td>
						<label for="inputEmail3" class="col-sm-2 control-label">Photograph<sup>*</sup></label></td>
						<td class="col-sm-2">
