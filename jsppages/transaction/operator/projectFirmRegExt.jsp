...
<div class="row">
		...
		<div class="col-md-3 col-sm-6 col-xs-6" ><p>From ${project.approvedOn.time} to ${project.expireDate.time}</p></div>
</div>
...
<div class="row">
     ...
     <div class="col-md-12">
     <h1>Supproting Documents<span> (If Any)</span></h1>
     <div class="drop_shadow"></div>
	 </div>
...
<form name="approvalForm" class="form-horizontal"  action="forwardProjectExtRegistration" class="form-horizontal"  method="post">

<input type='hidden' name='PROJECT_ID' value="${projectExt.projectExtId }" />
  <input type='hidden' name='STATUS' />
	<div class="form-group">
		<label for="inputEmail3" class="col-sm-2 control-label"> Assigning To: </label>
				<div class="col-sm-3">
