...
<form:form class="form-horizontal login" method="post" action="authorityLogin" name="loginForm">
  <div class="form-group  has-feedback ">
    <label for="inputEmail3" class="col-sm-3 control-label">Login Id :</label>
  <div class="col-sm-9">
      <span class="glyphicon glyphicon-user form-control-feedback"></span>
      <input type="text" class="form-control" name="loginId" id="loginId" placeholder="Please Enter Your login ID">
